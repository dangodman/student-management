    ...
    <el-container>
      ...
      <el-aside :width="iscollapse ? '64px' : '200px'">
        ...
        <el-menu background-color="#333744" text-color="#fff" active-text-color="#ffd04b" :collapse="iscollapse"
          ...
          <el-menu-item index="1" :index="sinformationpath">
            <i class="el-icon-s-home"></i>
            <span slot="title">学籍管理</span>
          </el-menu-item>
          <el-menu-item index="3" :index="sclassmanagepath">
            <i class="el-icon-s-home"></i>
...
export default {
  ...
  data() {
    return {
      iscollapse: false,
      sinformationpath: '/student/sinformation',
      sclassmanagepath: '/student/course'
    }
  },
  methods: {
    exit() {
